            ...
            <div class="row">
                <div class="col-lg-3 col-6">
                    <div class="small-box bg-info">
                        <div class="inner d-flex justify-content-center">  <img src='/payslips.png' width={"40px"} /> </div>
                ...
                <div class="col-lg-3 col-6">
                    <div class="small-box bg-success">
                        <div class="inner d-flex justify-content-center">  <img src='/holidays.png' width={"60px"} /> </div>
                        <div class="inner d-flex justify-content-center">
                            <h5>Holidays</h5>
                        </div>
                ...
                <div class="col-lg-3 col-6">
                    <div class="small-box bg-warning">
                        <div class="inner d-flex justify-content-center">  <img src='/leave.png' width={"40px"} /> </div>
                        <div class="inner d-flex justify-content-center">
                            <h5>Leave</h5>
                        </div>
                ...
                <div class="col-lg-3 col-6">
                    <div class="small-box bg-danger">
                        <div class="inner d-flex justify-content-center">  <img src='/my-profile.png' width={"40px"} /> </div>
                        <div class="inner d-flex justify-content-center">
                            <h5>My Profile</h5>
                        </div>
                    ...
                    <section class="col-lg-7 connectedSortable">
                        ...
                        <div class="card">
                            <div class="card-header  bg-gradient-teal">
                                <h3 class="card-title">
                                    <i class="fas fa-chart-pie mr-1"></i>
                                    Upcoming Confirmation Employees
                                </h3>
                                <div class="card-tools">
                            ...
                            <div class="card-body p-0 m-0">
                                <ConfirmEmployees conformemp={upcomingemp} />
                            </div>
                        </div>
